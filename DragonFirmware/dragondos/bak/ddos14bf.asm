...
LC21F   STA     ,X			; Update current track for current drive
        LDU     #ResetPIA
        EXG     U,PC
...
LC31B   LDA     #WDCmdForceInt		; Force the WD to abort
        STA     dpcmdreg
...
LC34E   
	...
	LEAY    -1,Y			; decrement timeout
        ...
        BRA     LC31B			; timout, abort, and return error
