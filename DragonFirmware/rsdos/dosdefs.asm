...
DosBuffStart	EQU	$060D		; Buffer start, same loc as auto line
DosBuffEnd	EQU	$060F		; Buffer end, same loc as auto increment
...
DrvDetFrelen	EQU	$02		; Free length
DrvDetFreEPtr	EQU	$03		; Free extent pointer
...
DosLSNCounter	EQU	$065C		; LSN counter
...
; Offsets of tables from Online table, this way we can point an indes register
...
FCBFSNExtent2	EQU	$18	; FSN of extent 1
FCBLSNExtent2	EQU	$1A	; LSN of extent 1 
FCBSecExtent2	EQU	$1C	; Sectors in extent 1
...
SyncTableCount	EQU	2	; Table entry in SyncSectorNos
SyncSecNo	EQU	3	; Sector we are syncing
SyncSectorNos	EQU	4	; 4 sectors currently being synced
SyncTableSize	EQU	4	; 4 Sync table entries
...
DDFirstError	EQU	DDErrNR		; First error code
