...
*
* 2017-03-17.  P.Harvey-Smith.
*   Changed tabs to be 4 characters.

;TextScreenBase  equ $0400               ; Default text screen base
GraphScreenBase equ $0600               ; Default Graphics screen base

TextLineLen equ     32                  ; 32 characters / line
...
PIACRDDR    equ     $04                 ; Select DDR or Data reg
