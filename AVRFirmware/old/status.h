...
#define HexDumpc(cond, Buff, Length, Port)	{if (cond) HexDump(Buff, Length, Port); }
#define HexDumpHeadc(cond, Buff, Length, Port)	{if (cond) HexDump(Buff, Length, Port); }
#else
#define log0(format,...) 
#define log1(format,...) 
...
#define log0i(format,...) 
#define HexDumpc(cond, Buff, Length, Port)	
#define HexDumpHeadc(cond, Buff, Length, Port)	
#endif
